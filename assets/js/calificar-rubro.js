  ...
  tbody.innerHTML = alumnos.map((a) => {
    ...
    return `
      <tr class="border-t border-outline-variant hover:bg-surface-bright transition-colors">
        ...
        <td class="py-3 px-6">
          <input type="number" min="0" max="10" step="0.1" class="input-calificacion w-24 px-3 py-2 rounded-DEFAULT border border-outline-variant" data-alumno="${a.id}" value="${valor}" placeholder="—"/>
        </td>
      </tr>`;
  }).join('');
